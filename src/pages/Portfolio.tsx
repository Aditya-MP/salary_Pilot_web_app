  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-400 mt-1">Your investment holdings and performance</p>
      </div>
      ...
      <div className="bg-black/40 backdrop-blur-xl border border-blue-500/20 rounded-xl p-6">
        <h2 className="text-xl font-semibold text-white mb-6">Holdings Breakdown</h2>
...
function HoldingRow({ name, value, change, color, total }: { name: string; value: number; change: number; color: 'blue' | 'purple' | 'green'; total: number }) {
  ...
  return (
    <div className="bg-white/5 rounded-lg p-4">
      ...
      <p className="text-xs text-gray-400 mt-1">{percentage.toFixed(1)}% of portfolio</p>
    </div>
  );
}
