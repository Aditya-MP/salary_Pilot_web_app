...
export default function AICoach() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-navy-900">AI Coach Agents</h1>
        <p className="text-slate-500 mt-1">Advanced assistance for smarter decisions</p>
      </div>
      ...
      <div className="bg-white/60 backdrop-blur-xl border border-slate-200/50 rounded-xl p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-navy-900 mb-4">Next Month Recommendation</h2>
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50 rounded-lg p-6">
          <div className="flex items-start gap-4">
            <div className="bg-emerald-100 p-3 rounded-lg">
              <TrendingUp className="text-emerald-600" size={32} />
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-navy-900 mb-2">Optimized Allocation Strategy</h3>
              ...
              <div className="mt-4 pt-4 border-t border-slate-200">
                ...
                <p className="text-2xl font-bold text-emerald-600 mt-1">18-22% CAGR</p>
              </div>
              <button
                onClick={() => setShowPopup(true)}
                className="mt-4 bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-lg font-semibold transition-all shadow-sm">
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setShowPopup(false)}>
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl border border-slate-200" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-2xl font-bold text-navy-900 mb-4">Confirm Strategy</h3>
            <div className="space-y-3 mb-6 text-sm text-slate-600">
              ...
              <div className="border-t pt-3 mt-3">
                <div className="flex justify-between"><span>AI Confidence:</span><span className="font-semibold text-emerald-600">87%</span></div>
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => { setApplied(true); setShowPopup(false); setTimeout(() => setApplied(false), 3000); }}
      ...
      <div className="bg-white/60 backdrop-blur-xl border border-slate-200/50 rounded-xl p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-navy-900 mb-4">AI Processing Architecture</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-600">
          <div className="bg-slate-50 rounded-lg p-4">
            <p className="font-semibold text-blue-600 mb-2">Cloud-Side Processing</p>
            <p>Heavy market analysis, trend detection, and fundamental research executed on cloud infrastructure</p>
          </div>
          <div className="bg-slate-50 rounded-lg p-4">
            <p className="font-semibold text-emerald-600 mb-2">Local Decision Control</p>
